<script>
  ...
  const info = [
    { label: "Location", value: "Oxford, United Kingdom" },
    { label: "Phone", value: "+44 795 562 4268", href: "tel:+447955624268" },
    {
      label: "Email",
      value: "info@techgfxlimited.com",
      href: "mailto:info@techgfxlimited.com",
      accent: true,
    },
  ];
  ...
  const socials = [
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/chukwuemeka-anyakora/",
    },
...
<SEO
  title="Contact"
  description="Get in touch with TechGFX to discuss your website, app, or digital product idea."
  url="https://techgfxlimited.com/contact/"
/>
  ...
  <div class="container contact-grid">
    <div class="contact-left">
      ...
      <h1 class="display" bind:this={heroH1}>
        Say <span class="serif-accent">hello.</span>
      </h1>
      ...
      <ul class="info-list">
        {#each info as item (item.label)}
          <li class="info-row">
            ...
            {#if item.href}
              <a href={item.href} class="info-value" class:accent={item.accent}
                >{item.value}</a
              >
            {:else}
    ...
    >
      <input
        type="hidden"
        name="_subject"
        value="New enquiry from techgfxlimited.com"
      />
